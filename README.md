...
![Files](https://img.shields.io/badge/File_C-214-blue?style=flat-square)
![Lines](https://img.shields.io/badge/Righe-7976-green?style=flat-square)

| Metrica | Valore |
|---------|--------|
| 📄 File C totali | 214 |
| 📋 File Header (.h) | 26 |
| 📝 Righe di codice | 7976 |
| 📁 Categorie | 27 |
| 📊 Media righe/file | 37 |
...
- **adt**: 2 file
- **allocazione_dinamica**: 2 file
- **array**: 19 file
- **array_multidimensionali**: 6 file
...
- **puntatori**: 8 file
- **ricorsione**: 3 file
- **simulazioni_secondo_parziale**: 12 file
- **stringhe**: 7 file
- **struct**: 5 file
- **tutorato**: 15 file
- **union**: 4 file
...
*📅 Aggiornato: 18/12/2025 14:11 UTC*
